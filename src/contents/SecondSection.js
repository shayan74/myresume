    ...
    return (
      ...
      <FullpageDiv className="2" id="SecondSection">
        ...
        <p className="AboutMeSubTitile">
          ...
          {data.sections[0].items[0].Education} | My degree is :{" "}
          {data.sections[0].items[0].Degree} | I studied in :{" "}
          {data.sections[0].items[0].University}
        </p>
        <p className="AboutMe">
        Experienced developer with a demonstrated history of working in the web and web app development industry. UX and UI Expert. 
        </p>
      </FullpageDiv>
      </Element>
    );
